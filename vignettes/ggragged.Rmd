---
title: "ggragged: Ragged Grids for 'ggplot2'"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ggragged: Ragged Grids for 'ggplot2'}
...
groups. Here we showcase some examples of applying ragged grid layouts.
